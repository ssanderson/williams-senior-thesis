...
$\ndetp \subseteq \exp$ over any ring or field and that $\ndetp =
...
right as well as read and write symbols to and from the tape. The
machine's program consists of a set of states along with a transition
function, which provides instructions for how the tape head operates
and how the machine transitions from state to state.  These ideas are
...
\begin{definition}{Turing Machine}
  ...
  \times Q \times$ encoding the symbols currently written on the tape,
...
integers. By convention, we use the symbol $x$ to denote a polynomial
...
semi/quasi algebraic sets.
  ...
  \begin{proofsketch}
    ...
    computation performed by a machine at any  Thus for any particular size input and any particular
