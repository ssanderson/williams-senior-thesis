...
algebraic sets.  Before we proceed, we need a few more definitions.
  ...
  The upper half of the unit circle in $\reals^2$ is a basic
  quasi-algebraic set defined by solutions to the equations:
  \begin{eqnarray*}
    x^2 + y^2 = 0\\
    y = 0
  \end{eqnarray*}
  ...
  \begin{definition}{\textbf{Initial computation path} and \textbf{time-T halting path set}}
    ...
    $\inspace_M$, and let $\computepath = \computepath_M(x)$ be the
    computation path of $M$ on $x$.  
