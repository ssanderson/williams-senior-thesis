...
\begin{proofsketch}
  ...
  \note{The parallelization construction generalized nicely to any
    integral number of machines.}
...
\section{Characterization of Decidable Sets}
  ...
  \begin{proofsketch}
    ...
    \item \textbf{(1)} follows from the fact that there are finitely
      ...
      sequence of polynomial equalities and inequalities, so all the
